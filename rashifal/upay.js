const upayData = [
    ...
    { rashi: "सिंह (Leo)", icon: "🦁", upay: "आज सूर्य देव को जल दें, परंतु शनि के दुष्प्रभाव से बचने के लिए लोहे की वस्तु का दान करने से लाभ होगा।" },
    ...
    { rashi: "वृश्चिक (Scorpio)", icon: "🦂", upay: "हनुमान चालीसा का पाठ करें। आज के दिन तामसिक भोजन से बचें और शनि देव को उड़द की दाल का भोग लगाएं।" },
